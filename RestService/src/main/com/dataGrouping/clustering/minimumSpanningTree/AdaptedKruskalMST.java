 ...
 *******************************************************************************/
package com.dataGrouping.clustering.minimumSpanningTree;

import com.dataGrouping.clustering.HierarchicalClusterTree;
...
/**
 * An modified KruskalMST to use as Single Linkage Clustering
 * @author Erwin
 */
/**
 ...
 *  @author Kevin Wayne
 */
public class AdaptedKruskalMST {
    private double weight;  // weight of MST
    private Queue<Edge> mst = new Queue<Edge>();  // edges in MST
    private HierarchicalClusterTree clusterTree;  // cluster Tree representing the clusters of each hierarchical level

    /**
     * Compute a minimum spanning tree (or forest) of an edge-weighted graph.
     * @param G the edge-weighted graph
     */
    public AdaptedKruskalMST(EdgeWeightedGraph G) {
...
//            	   break;
        ...
        // REMOVED as we do not necessarily end up with a MST.
        // assert check(G);
    }
    ...
    public static void main(String[] args) {
      //  In in = new In(args[0]);
    	double[][] matrix = { {0,4,1},{4,0,2},{1,2,0} };
        EdgeWeightedGraph G = new EdgeWeightedGraph(matrix);
